...
uw_Basis_string uw_Basis_sqlifyNumeric(struct uw_context *, uw_Basis_numeric);
uw_Basis_string uw_Basis_sqlifyNumericN(struct uw_context *, uw_Basis_numeric *);
...
uw_Basis_string uw_Basis_sqlifyTimeOfDay(struct uw_context *, uw_Basis_timeOfDay);
uw_Basis_string uw_Basis_sqlifyTimeOfDayN(struct uw_context *, uw_Basis_timeOfDay *);
uw_Basis_string uw_Basis_timeOfDayToString(struct uw_context *, uw_Basis_timeOfDay);
uw_Basis_timeOfDay uw_Basis_stringToTimeOfDay(struct uw_context *, uw_Basis_string);
uw_Basis_timeOfDay uw_Basis_stringToTimeOfDay_error(struct uw_context *, uw_Basis_string);
...
extern char *uw_sqlsuffixTimeOfDay;
